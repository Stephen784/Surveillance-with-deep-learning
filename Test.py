...
face_cascade = cv2.CascadeClassifier('C:/Users/Public/Downloads/Surveillance with deep learning/New folder/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('C:/Users/Public/Downloads/Surveillance with deep learning/New folder/haarcascade_eye.xml')
...
while 1:
    ...
    if len(faces) == 0:
        ...
        print('Analysing Behavior')
        cv2.putText(img, "UNKNOWN EVENT ", (0, img.shape[0] -10), cv2.FONT_HERSHEY_TRIPLEX, 0.5,  (0, 0, 255), 1)
        Sec = 0
        Min = 0
